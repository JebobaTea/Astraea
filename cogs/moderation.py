...
class Moderation(commands.Cog):
    ...
    async def slowmode(self, ctx, seconds: int):
        ...
        embed = discord.Embed(title='Moderation Tools',
                              description='A slowmode of ' + str(seconds) + ' seconds was set for this channel',
    ...
    async def ban(self, ctx, *, member: discord.Member = None):
        if member is not None:
            ...
            embed = discord.Embed(title='Moderation Tools', description='No member specified!',
                                  color=discord.Color.red())
            await ctx.send(embed=embed)

    @commands.command()
    @commands.has_guild_permissions(ban_members=True)
    async def unban(self, ctx, *, uid=None):
        if id is not None:
    ...
    async def mute(self, ctx, *, member: discord.Member = None):
        if discord.utils.get(member.guild.roles, name='Muted'):
            ...
            if role in member.roles:
                ...
                embed = discord.Embed(title='Moderation Tools', description='Member muted.',
                                      color=discord.Color.green())
                await ctx.send(embed=embed)
        else:
    ...
    async def unmute(self, ctx, *, member: discord.Member = None):
        if discord.utils.get(member.guild.roles, name='Muted'):
            ...
            if role in member.roles:
                ...
                embed = discord.Embed(title='Moderation Tools', description='Member unmuted.',
                                      color=discord.Color.green())
                await ctx.send(embed=embed)
            else:
                embed = discord.Embed(title='Moderation Tools', description='Member isn\'t muted!',
                                      color=discord.Color.red())
                await ctx.send(embed=embed)
        else:
            perms = discord.Permissions(send_messages=False, read_messages=True)
